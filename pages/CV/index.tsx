...
const statDefs = [
  {
    value: "3+",
    labelKey: "cv.yearsExp",
    gradient: "from-violet-500 to-purple-600",
    bg: "from-violet-50 to-purple-50 dark:from-violet-950/20 dark:to-purple-950/15",
  },
  {
    value: "800h",
    labelKey: "cv.practiceHours",
    gradient: "from-pink-500 to-rose-600",
    bg: "from-pink-50 to-rose-50 dark:from-pink-950/20 dark:to-rose-950/15",
  },
  {
    value: "15+",
    labelKey: "cv.projects",
    gradient: "from-cyan-500 to-blue-600",
    bg: "from-cyan-50 to-blue-50 dark:from-cyan-950/20 dark:to-blue-950/15",
  },
  {
    value: "20+",
    labelKey: "cv.technologies",
    gradient: "from-orange-500 to-amber-600",
    bg: "from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/15",
  },
];
...
export default function ResumePage() {
  ...
  return (
    <DefaultLayout
      seo={{ title: t("meta.cv.title"), description: t("meta.cv.desc") }}
    >
          ...
          <ScrollReveal>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {statDefs.map((s, idx) => (
                <div
                  key={idx}
                  className={`group p-6 rounded-2xl text-center bg-gradient-to-br ${s.bg} border border-black/8 dark:border-white/8 hover:scale-[1.03] transition-all duration-300 overflow-hidden relative`}
                >
                  <div
                    className={`absolute -bottom-6 -right-6 w-24 h-24 rounded-full bg-gradient-to-br ${s.gradient} opacity-20 blur-2xl group-hover:opacity-35 transition-opacity`}
                  />
                  <p
                    className={`text-4xl font-black bg-gradient-to-br ${s.gradient} bg-clip-text text-transparent relative`}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="absolute left-4 md:left-1/2 -translate-x-1/2 z-10">
                          <div
                            className={`w-4 h-4 rounded-full bg-gradient-to-br ${edu.color} border-2 border-white dark:border-[#111116] shadow-md`}
                          />
                        </div>
                        <div className={`flex-1 ml-10 md:ml-0`}>
                          ...
                          >
                            ...
                            >
                              <span
                                className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold text-white bg-gradient-to-br ${edu.color} shadow-sm`}
                              >
                                {EDU_ICONS[edu.id]}
                                {edu.level}
                              </span>
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                {topSkills.map((skill) => (
                  <div
                    key={skill.name}
                    className="p-4 rounded-2xl bg-white dark:bg-[#111116] border border-black/8 dark:border-white/8"
                  >
            ...
            <section className="relative rounded-3xl overflow-hidden bg-[#0a0a0f]">
              ...
              <div className="relative px-8 md:px-16 py-16 md:py-20 text-center space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                  <a
                    className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-white text-[#1d1d1f] font-bold text-sm hover:bg-white/90 transition-all shadow-2xl shadow-black/20 hover:scale-105"
                  ...
                  <Link
                    className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-white font-bold text-sm transition-all border border-white/20 no-underline hover:scale-105"
                    href={siteConfig.links.linkedin}
                    rel="noopener noreferrer"
                    target="_blank"
                  >
