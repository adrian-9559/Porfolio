...
export default function ResumePage() {
  ...
  return (
    <DefaultLayout
      seo={{
        title: t("meta.cv.title"),
        description: t("meta.cv.desc"),
      }}
    >
      <div className="relative">
        ...
        <div className="space-y-16 py-4 md:py-8">
          ...
          <div className="space-y-4">
            <p className="section-label">{t("cv.title")}</p>
            <h1
              ...
              <div className="space-y-6">
                {educationData.map((edu, idx) => (
                  ...
                  >
                    {/* Timeline dot */}
                    <div
                      className={`absolute -left-8 top-6 w-6 h-6 rounded-full bg-gradient-to-br ${edu.color} flex items-center justify-center shadow-md flex-shrink-0 group-hover:scale-110 transition-transform duration-200`}
                    >
                    ...
                    <div className="flex-1 p-5 md:p-6 rounded-2xl bg-white dark:bg-[#111116] border border-black/8 dark:border-white/8 group-hover:border-black/15 dark:group-hover:border-white/15 group-hover:shadow-lg group-hover:shadow-black/5 dark:group-hover:shadow-black/20 transition-all duration-200">
                      <div className="flex items-start gap-4">
                        {/* Level badge */}
                        <div
                          className={`w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br ${edu.color} flex items-center justify-center text-white text-xs md:text-sm font-bold flex-shrink-0 shadow-sm`}
                        >
                          {edu.level}
                        </div>
