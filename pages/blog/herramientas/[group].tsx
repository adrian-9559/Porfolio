...
import {
  ...
  getToolGroupBySlug,
  ToolGroup,
} from "@/lib/blog/toolGroups";
import { siteConfig } from "@/config/site";
import { IconChevronLeft, IconClose } from "@/components/blog/shared";
...
> = {
  ...
  "case-converter": {
    ...
    activeBg:
      "bg-indigo-100 dark:bg-indigo-950/40 border-indigo-300 dark:border-indigo-700",
  },
  "diff-checker": {
    bg: "bg-indigo-50 dark:bg-indigo-950/20",
    text: "text-indigo-600 dark:text-indigo-400",
  ...
  "palette-generator": {
    ...
    activeBg:
      "bg-fuchsia-100 dark:bg-fuchsia-950/40 border-fuchsia-300 dark:border-fuchsia-700",
  },
  "color-tool": {
    bg: "bg-fuchsia-50 dark:bg-fuchsia-950/20",
    text: "text-fuchsia-600 dark:text-fuchsia-400",
  ...
  "unit-converter": {
    ...
    activeBg:
      "bg-teal-100 dark:bg-teal-950/40 border-teal-300 dark:border-teal-700",
  },
  "tip-calculator": {
    bg: "bg-teal-50 dark:bg-teal-950/20",
    text: "text-teal-600 dark:text-teal-400",
  ...
  "code-minifier": {
    ...
    activeBg:
      "bg-violet-100 dark:bg-violet-950/40 border-violet-300 dark:border-violet-700",
  },
  "box-shadow": {
    bg: "bg-fuchsia-50 dark:bg-fuchsia-950/20",
    text: "text-fuchsia-600 dark:text-fuchsia-400",
...
const DEFAULT_COLORS = {
  ...
  activeBg:
    "bg-gray-100 dark:bg-gray-950/40 border-gray-300 dark:border-gray-700",
};
      ...
      <div className="space-y-8 py-4">
        ...
        <header className="space-y-4">
          <div className="flex items-center gap-4">
            <div
              className={`w-11 h-11 rounded-2xl flex items-center justify-center ${group.color} ${group.text}`}
            >
              {GROUP_ICON[group.id] ?? (
