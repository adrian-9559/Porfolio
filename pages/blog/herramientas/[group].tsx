...
> = {
  ...
  "uuid-generator": {
    ...
    activeBg: "bg-sky-100 dark:bg-sky-950/40 border-sky-300 dark:border-sky-700",
  },
  "timestamp-converter": {
  ...
  "case-converter": {
    ...
    activeBg: "bg-rose-100 dark:bg-rose-950/40 border-rose-300 dark:border-rose-700",
  },
  "diff-checker": {
  ...
  base64: {
    ...
    text: "text-cyan-600 dark:text-cyan-40",
  ...
  "regex-tester": {
    ...
    activeBg: "bg-orange-100 dark:bg-orange-950/40 border-orange-300 dark:border-orange-700",
  },
  "qr-generator": {
    bg: "bg-amber-50 dark:bg-amber-950/20",
  ...
  "palette-generator": {
    ...
    activeBg: "bg-pink-100 dark:bg-pink-950/40 border-pink-300 dark:border-pink-700",
  },
  "color-tool": {
