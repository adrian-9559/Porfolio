...
const contactMethods = [
	...
	},
	{
		label: "Ubicación",
		value: "Madrid, España",
		description: "Disponible para trabajo remoto o presencial",
...
const socials = [
	...
	{ name: "Instagram", href: siteConfig.links.instagram, icon: (
		<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
		...
		<DefaultLayout>
			<div className="space-y-16 py-4 md:py-8">
				...
				<div className="space-y-4">
					...
					<h1 className="text-5xl md:text-6xl font-bold tracking-tight" style={{ letterSpacing: "-0.03em" }}>
						Trabajemos juntos
					</h1>
					<p className="text-lg text-[#6e6e73] dark:text-[#86868b] max-w-xl">
						¿Tienes un proyecto interesante? Me encantaría escucharte y colaborar contigo.
					</p>
				</div>
						...
						{contactMethods.map((method, idx) => (
							...
							>
								...
								<div>
									...
									<p className="text-xs text-[#6e6e73] dark:text-[#86868b] mt-0.5">{method.value}</p>
									<p className="text-xs text-[#aeaeb2] dark:text-[#636366] mt-1">{method.description}</p>
								</div>
							</Link>
						))}
