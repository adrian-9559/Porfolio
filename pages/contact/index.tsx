        ...
        <div className="space-y-16">
          ...
          <ScrollReveal>
            <div className="space-y-4">
              <span className="ds-section-label">{t("contact.title")}</span>
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              {contactMethods(t).map((method, idx) => (
                <ScrollReveal key={idx} delay={idx * 100} direction="left">
                  <Link
                    className="group block relative p-5 rounded-2xl ds-card no-underline overflow-hidden mb-4"
                    href={method.href}
                    rel={
                  ...
                  >
                    <div
                      className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${method.gradient} opacity-80`}
                    />
                    <div className="relative flex items-start gap-4">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${method.gradient} flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
                        {method.icon}
                      </div>
                      <div>
                ...
                <div className="pt-6 border-t border-[var(--border-default)]">
                  ...
                  <div className="flex gap-3">
                    {socials.map((s, i) => (
                      <Link
                        key={i}
                        className="w-11 h-11 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-default)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--accent)] hover:border-[var(--accent)] transition-all duration-300 no-underline"
                        href={s.href}
