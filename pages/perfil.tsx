...
const servicesDef = (t: (k: string) => string) => [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 8.165 6 10.388 6 13v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth={2}
        />
        ...
        <div className="max-w-5xl mx-auto space-y-8 py-4">
          ...
          <ScrollReveal>
            <div className="relative rounded-3xl overflow-hidden border border-black/8 dark:border-white/8">
              ...
              <div
                ref={statsRef}
                className="border-t border-black/8 dark:border-white/8 grid grid-cols-4 bg-white dark:bg-[#111116]"
              >
                {stats.map((s, i) => (
                  <div
                    key={s.label}
                  ...
                  >
                    <div
                      className={`w-9 h-9 rounded-xl bg-gradient-to-br ${s.gradient} flex items-center justify-center mb-2 shadow-md`}
                    >
                      {s.icon}
                    </div>
                    <p
                      className="text-xl font-black text-[#1d1d1f] dark:text-white"
                      style={{ letterSpacing: "-0.02em" }}
                    >
                      <AnimatedCounter
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                {SERVICES.map((s, idx) => (
                  <ScrollReveal key={s.id} delay={idx * 60}>
                    ...
                    >
                      <div
                        className={`absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r ${s.gradient} opacity-60`}
                      />
                      <div
                        className={`w-10 h-10 rounded-xl bg-gradient-to-br ${s.gradient} flex items-center justify-center mb-3 shadow-md group-hover:scale-110 transition-transform duration-300`}
                      >
                        {s.icon}
                      </div>
    ...
    <div className="rounded-xl bg-white dark:bg-[#111116] border border-black/8 dark:border-white/8 p-4 h-full">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div
            className={`w-7 h-7 rounded-lg bg-gradient-to-br ${gradient} flex items-center justify-center shadow-sm`}
          >
            <svg
