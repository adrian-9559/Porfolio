...
function getStrength(
  ...
  if (score <= 4) return { label: "Good", score: 3, color: "bg-emerald-500" };

  return { label: "Strong", score: 4, color: "bg-blue-500" };
}
    ...
    <article className="max-w-2xl">
      ...
      <div className="space-y-3 mb-10">
        ...
        <p className="text-lg text-[#6e6e73] dark:text-[#86868b] leading-relaxed">
          Create secure, random passwords instantly. Customize length and
          character types.
        </p>
      </div>
