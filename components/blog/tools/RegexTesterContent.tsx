...
const EXAMPLES = [
  {
    ...
    flags: "g",
    text: "Contacta en hola@ejemplo.com o info@empresa.org para más info.",
  },
  {
    label: "URL",
    pattern: "https?:\\/\\/[^\\s]+",
    flags: "g",
    text: "Visita https://google.com o http://ejemplo.org para más info.",
  },
  {
    label: "Teléfono ES",
    pattern: "(\\+34|0034)?[6-9]\\d{8}",
    flags: "g",
    text: "Llama al 612345678 o al +34 987654321.",
  },
  {
    label: "Fecha DD/MM/YYYY",
    pattern: "\\d{2}\\/\\d{2}\\/\\d{4}",
    flags: "g",
    text: "Nacido el 15/03/1990, expira el 31/12/2025.",
  },
  {
    label: "Hex color",
    pattern: "#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})",
    flags: "g",
    text: "Colores: #fff, #3b82f6, #FF5733 y #abc.",
  },
];
