...
export default function McpSecurityContent() {
  return (
    <article className="max-w-3xl">
      ...
      <BlogH2>Modelo de amenazas</BlogH2>
      <BlogP>
      ...
      <BlogH3>Acceso al sistema de archivos</BlogH3>
      <BlogP>
        Servidores como{" "}
      ...
      <BlogH3>Exfiltración por HTTP / SSE</BlogH3>
      <BlogP>
      ...
      <BlogH3>Acceso a tokens de entorno</BlogH3>
      <BlogP>
      ...
      <BlogH3>Ejecución de comandos arbitrarios</BlogH3>
      <BlogP>
      ...
      <BlogH2>Auditar un servidor antes de instalarlo</BlogH2>
      <BlogP>
      ...
      <BlogH2>Buenas prácticas de configuración</BlogH2>
      <BlogP>
...
"servers": {
  ...
  mcp-filesystem:
    ...
    read_only: true`}</BlogCode>
      ...
      <BlogH2>MCPs de confianza vs comunidad</BlogH2>
      <BlogP>
      ...
      <table className="w-full text-sm border-collapse mb-6">
        ...
        <tbody className="text-[#3a3a3c] dark:text-[#aeaeb2]">
          <tr className="border-b border-black/6 dark:border-white/6">
            ...
            <td className="py-2">
              Alta — mantenidos por el equipo de Anthropic
            </td>
          </tr>
          <tr className="border-b border-black/6 dark:border-white/6">
            ...
            <td className="py-2">Alta — empresas verificadas</td>
          </tr>
          <tr className="border-b border-black/6 dark:border-white/6">
            ...
            <td className="py-2">Media — revisar código antes de usar</td>
          </tr>
          <tr>
            ...
            <td className="py-2">Baja — auditoría obligatoria</td>
          </tr>
        </tbody>
      </table>
      <BlogP>
      ...
      <BlogH2>Lista de verificación de seguridad</BlogH2>
      <BlogP>
