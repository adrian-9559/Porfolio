...
const platforms = [
  {
    ...
    description:
      "La plataforma creada por el equipo de Next.js. Despliegue automático desde GitHub, preview deployments por PR y edge functions globales. Es el estándar actual para apps React y Next.js.",
    pros: [
      "Deploy instantáneo desde GitHub/GitLab",
      "Preview por cada Pull Request",
      "Edge Network en 70+ regiones",
      "Analytics integrado",
      "Perfect para Next.js",
    ],
    cons: [
      "Plan gratuito tiene límite de 100GB/mes de ancho de banda",
      "Builds lentos en plan gratuito",
    ],
  },
  {
    name: "Netlify",
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "Pionero en el JAMstack. Excelente para sites estáticos, Gatsby, Astro y cualquier framework. Incluye forms, identidad y funciones serverless.",
    pros: [
      "Formularios gratuitos (100 envíos/mes)",
      "Despliegue visual drag & drop",
      "Split testing integrado",
      "Netlify Functions (serverless)",
    ],
    cons: [
      "Build minutes limitados en plan gratuito (300 min/mes)",
      "Menor optimización para Next.js que Vercel",
    ],
  },
  {
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "La opción más generosa en plan gratuito. Requests ilimitados, ancho de banda ilimitado y acceso a la red de Cloudflare. Workers para lógica serverless.",
    pros: [
      "Ancho de banda ilimitado gratis",
      "Requests ilimitados gratis",
      "Red global de Cloudflare (<50ms)",
      "Cloudflare Workers integrado",
    ],
    cons: [
      "Ecosistema menos maduro para Next.js",
  ...
  },
  {
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "Hosting estático directamente desde tu repositorio de GitHub. Ideal para portfolios, documentación y proyectos open source. No soporta SSR.",
    pros: [
    ...
    cons: [
      "Solo sitios estáticos (sin SSR/API routes)",
      "Builds más lentos",
  ...
  },
  {
    ...
    description:
      "Plataforma completa que soporta tanto frontend estático como backend. Perfecta cuando tu app tiene frontend + API en el mismo proyecto.",
    pros: [
      "Static Sites gratuitos",
      "Se integra con backend en Render",
      "Redirecciones y headers configurables",
      "Auto-deploy desde Git",
    ],
    cons: [
      "Los servicios gratuitos se apagan tras inactividad",
      "Sin Edge Network avanzado",
    ],
  },
  {
    name: "Surge",
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "La forma más rápida de publicar un site estático. Un solo comando en terminal y listo. Perfecto para demos rápidas y prototipos.",
    pros: [
      "Un solo comando: surge ./dist",
    ...
    <article className="max-w-3xl">
      ...
      <div className="space-y-3 mb-10">
        ...
        <p className="text-lg text-[#6e6e73] dark:text-[#86868b] leading-relaxed">
          Las mejores opciones para publicar tu app React, Next.js, Vue o
          cualquier framework frontend. Con planes gratuitos, comparativa y
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none mb-10">
        <p className="text-[#3d3d3d] dark:text-[#c0c0c5] leading-relaxed">
          Elegir bien dónde alojar tu frontend marca la diferencia en
          rendimiento, experiencia de desarrollo y coste. En 2026 hay opciones
          excelentes con planes gratuitos muy generosos. Aquí tienes las que uso
          y recomiendo.
        </p>
        <div className="mt-4 p-4 rounded-xl bg-violet-50 dark:bg-violet-950/20 border border-violet-200 dark:border-violet-800/40">
          ...
          <p className="text-sm text-violet-700 dark:text-violet-400">
            Para Next.js → Vercel. Para todo lo demás estático → Cloudflare
            Pages (ancho de banda ilimitado gratis). Para demos rápidas → Surge.
          </p>
        </div>
      </div>
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-br from-violet-50 to-blue-50 dark:from-violet-950/20 dark:to-blue-950/20 border border-violet-200 dark:border-violet-800/40">
        ...
        <p className="text-sm text-[#3d3d3d] dark:text-[#c0c0c5] leading-relaxed">
          Para proyectos personales y portfolios uso <strong>Vercel</strong> si
          hay Next.js y <strong>Cloudflare Pages</strong> para todo lo demás.
          Ambos tienen un DX excelente y el plan gratuito es más que suficiente
