...
const platforms = [
  {
    ...
    description:
      "La plataforma de backend más cómoda en 2026. Deploy desde GitHub en segundos, variables de entorno desde la interfaz y soporte para casi cualquier stack: Node.js, Python, Rust, Go, Docker…",
    pros: [
      "Deploy en 1 clic desde GitHub",
      "Variables de entorno en UI",
      "PostgreSQL/MySQL/Redis integrados",
      "Logs y métricas en tiempo real",
      "Escala automáticamente",
    ],
    cons: [
      "Plan gratuito tiene $5/mes de crédito (se agota)",
      "Sin free tier permanente tras el cambio de 2024",
    ],
  },
  {
    name: "Render",
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "Buena alternativa a Heroku. Ofrece servicios web, workers, cron jobs y bases de datos. El plan gratuito incluye servicios web que se apagan tras 15 min de inactividad.",
    pros: [
      "Servicios web gratuitos",
      "PostgreSQL gratuito (90 días)",
      "Cron jobs integrados",
      "Deploy desde Docker o Git",
    ],
    cons: [
      "Servicios gratuitos se apagan tras inactividad (cold start ~30s)",
  ...
  },
  {
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "Ejecuta contenedores Docker en múltiples regiones. Perfecto para apps que necesitan estar cerca del usuario en todo el mundo. El plan gratuito incluye 3 VMs pequeñas.",
    pros: [
      "Despliegue en múltiples regiones",
      "Volumenes persistentes",
      "3 VMs gratis siempre",
      "Soporte nativo de SQLite + LiteFS",
      "flyctl CLI muy potente",
    ],
    cons: [
  ...
  },
  {
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "Alternativa emergente con un plan gratuito sin expiración. Soporta Node.js, Python, Go y Docker. No duerme los servicios como Render. Edge deployment en múltiples regiones.",
    pros: [
      "Servicios gratuitos sin cold start",
      "Sin límite de tiempo en plan gratuito",
      "Edge functions incluidas",
      "Deploy desde Git o Docker",
    ],
    cons: [
      "Comunidad y documentación más limitada",
      "Menos integraciones que Railway o Render",
    ],
  },
  {
    ...
    description:
      "La opción más robusta para producción seria. Managed databases, load balancers, CDN y scaling automático. Más caro pero más confiable para apps con usuarios reales.",
    pros: [
      "SLA 99.99% de uptime",
  ...
  },
  {
    ...
    planColor: "text-green-600 dark:text-green-400",
    description:
      "Edge computing de Cloudflare. Ejecuta código JavaScript/TypeScript en la red de Cloudflare en más de 200 ubicaciones. Ideal para APIs ultrarrápidas y middleware global.",
    pros: [
      "100.000 requests/día gratuitos",
      "Latencia <10ms en todo el mundo",
      "KV Store, Durable Objects y R2",
      "Despliegue instantáneo",
      "Gratis para muchos proyectos reales",
    ],
    cons: [
      "Sin Node.js nativo (runtime propio)",
      "No es un servidor tradicional",
      "Limitaciones de CPU (10ms por request en free)",
    ],
  },
];
...
const casos = [
  {
    caso: "API REST de hobby/portfolio",
    recomendacion: "Railway o Koyeb",
    razon: "Fácil de usar, suficiente gratis",
  },
  {
    caso: "App con muchos usuarios (>10k/mes)",
    recomendacion: "DigitalOcean / Railway paid",
    razon: "SLA, scaling y soporte",
  },
  {
    caso: "API global con baja latencia",
    recomendacion: "Cloudflare Workers + Fly.io",
    razon: "Edge computing",
  },
  {
    caso: "Microservicio o workers",
    recomendacion: "Cloudflare Workers",
    razon: "100k req/día gratis",
  },
  {
    caso: "App completa (frontend + backend)",
    recomendacion: "Railway",
    razon: "Todo en un sitio",
  },
  {
    caso: "Demo o PoC rápido",
    recomendacion: "Render (free tier)",
    razon: "Rápido de configurar",
  },
];
    ...
    <article className="max-w-3xl">
      ...
      <div className="space-y-3 mb-10">
        ...
        <p className="text-lg text-[#6e6e73] dark:text-[#86868b] leading-relaxed">
          Dónde alojar tu API, servidor Node.js, Python, Go o cualquier backend
          en 2026. Con planes gratuitos, análisis honesto y guía de cuándo usar
          cada uno.
        </p>
      </div>
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none mb-10">
        <p className="text-[#3d3d3d] dark:text-[#c0c0c5] leading-relaxed">
          Elegir dónde alojar tu backend es más crítico que el frontend: afecta
          a la latencia, la disponibilidad y el coste de escalar. El mercado ha
          cambiado mucho: Heroku ya no es la opción obvia y hay alternativas
          mejores para casi todos los casos de uso.
        </p>
        <div className="mt-4 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800/40">
          ...
          <p className="text-sm text-emerald-700 dark:text-emerald-400">
            Para proyectos personales → Railway (mejor DX). Para producción
            seria → DigitalOcean. Para APIs globales ultrarrápidas → Cloudflare
            Workers.
          </p>
        </div>
      </div>
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-emerald-950/20 dark:to-blue-950/20 border border-emerald-200 dark:border-emerald-800/40">
        ...
        <p className="text-sm text-[#3d3d3d] dark:text-[#c0c0c5] leading-relaxed">
          Para proyectos personales uso <strong>Railway</strong>: la mejor
          experiencia de desarrollo, deploy en segundos y todo en un panel. Para
          APIs que necesitan escalar globalmente,{" "}
          <strong>Cloudflare Workers</strong> es imbatible en precio y
          rendimiento.
        </p>
      </div>
    </article>
