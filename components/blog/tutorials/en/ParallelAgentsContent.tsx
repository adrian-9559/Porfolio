  ...
  return (
    <article className="max-w-3xl">
      ...
      <p className="text-base md:text-lg text-[#6e6e73] dark:text-[#86868b] leading-relaxed mb-8">
        Learn to split complex tasks among multiple agents que trabajan
      ...
      <BlogH2>What are parallel agents?</BlogH2>
      <BlogP>
      ...
      <BlogH2>When to use parallel agents?</BlogH2>
      <BlogP>
      ...
      <BlogH2>How it works in OpenCode</BlogH2>
      <BlogP>
      ...
      <BlogH2>Task division: the key to success</BlogH2>
      <BlogP>
...
3. Cómo probarlo (curl)`}</BlogCode>
      ...
      <BlogH2>Practical example 1: Crear 3 componentes independientes</BlogH2>
      <BlogP>
...
Cada agente: dime al final la ruta del archivo creado."`}</BlogCode>
      ...
      <BlogH2>Practical example 2: Refactor por capas</BlogH2>
      <BlogP>
...
Todos los agentes: dime qué archivos creaste y qué funciones exportaste."`}</BlogCode>
      ...
      <BlogH2>Practical example 3: Feature completa</BlogH2>
      <BlogP>
