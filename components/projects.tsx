...
export default function Projects() {
  ...
  const projects: Project[] = [
    {
      title: "GymGO",
      description: t("sections.projects.gymgoDesc"),
    ...
    {
      title: "ft_irc",
      description: t("sections.projects.ftircDesc"),
    ...
    {
      title: "cub3D",
      description: t("sections.projects.cub3dDesc"),
    ...
    {
      title: "CodeXplore",
      description: t("sections.projects.codexploreDesc"),
      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {projects.map((project, idx) => (
            ...
            >
              <div
                className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${project.gradient} opacity-80`}
              />
              <div
                className={`absolute -top-10 -left-10 w-32 h-32 rounded-full bg-gradient-to-br ${project.gradient} opacity-10 blur-2xl group-hover:opacity-20 transition-opacity`}
              />
                ...
                <div className="flex gap-4 mt-5 pt-4 border-t border-black/6 dark:border-white/6">
                  {project.github && (
                    ...
                    >
                      ...
                      {t("sections.projects.githubLink")}
                    </Link>
                  )}
                  {project.demo && (
                    <Link
