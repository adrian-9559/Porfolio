  ...
  return (
    <div className="relative flex flex-col gap-6 overflow-hidden">
        ...
        {(["github", "gitlab", "bitbucket"] as Provider[]).map((p) => (
          ...
          >
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-medium capitalize text-[#6e6e73] dark:text-[#86868b]">
                  {p}
                </p>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-black/8 dark:border-white/8 bg-white dark:bg-[#111116]">
        <div
          className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-500 opacity-0 transition-opacity hover:opacity-100"
            ...
            {filtered.map((r) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-xs text-[#6e6e73] dark:text-[#86868b]">
                    {r.repository_url}
                  </p>
                </div>
