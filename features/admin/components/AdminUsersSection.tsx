  ...
  return (
    <div className="relative flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        {[
          {
            label: t("admin.userStatsTotal"),
            value: stats.total,
            gradient: "from-blue-500 to-indigo-600",
            icon: "users",
          },
          {
            label: t("admin.userStatsAdmins"),
            value: stats.admins,
            gradient: "from-purple-500 to-violet-600",
            icon: "shield",
          },
          {
            label: t("admin.userStatsConfirmed"),
            value: stats.confirmed,
            gradient: "from-emerald-500 to-teal-500",
            icon: "check",
          },
          {
            label: t("admin.userStatsUnconfirmed"),
            value: stats.unconfirmed,
            gradient: "from-amber-500 to-orange-500",
            icon: "alert",
          },
          {
            label: t("admin.userStatsRoles"),
            value: stats.roles,
          ...
          <>
            ...
            <div className="divide-y divide-black/5 dark:divide-white/5">
              {paginated.map((u) => (
                <div
                  key={u.id}
                  className="group grid grid-cols-1 md:grid-cols-[1fr_1.5fr_1.2fr_0.8fr] gap-2 md:gap-4 items-center px-5 py-3.5 hover:bg-black/2 dark:hover:bg-white/2 transition-colors"
                >
                  {/* Name + Avatar */}
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-[#aeaeb2] dark:text-[#636366] md:hidden truncate">
                        {u.email}
                      </p>
                    </div>
                  </div>
                  {/* Email (desktop) */}
                  <span className="hidden md:block text-sm text-[#6e6e73] dark:text-[#86868b] truncate">
                    {u.email}
                  </span>
                  {/* Roles */}
