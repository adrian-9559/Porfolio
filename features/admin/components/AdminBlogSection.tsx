        ...
        {filtered.length === 0 ? (
          ...
          <div className="flex flex-col">
            {filtered.map((c) => (
              ...
              >
                <div className="w-9 h-9 rounded-lg bg-[var(--bg-primary)] border border-[var(--border-default)] flex items-center justify-center text-[var(--text-secondary)] shrink-0">
                  {TYPE_ICONS[c.type]}
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`admin-badge ${TYPE_BADGE_CLASS[c.type]}`}>
                      {TYPE_LABEL[c.type]}
                    </span>
                    {c.featured && (
                ...
                <a
                  className="ds-btn-ghost p-2 text-[var(--text-muted)] hover:text-[var(--accent)]"
