...
export function AdminIssuesSection() {
  ...
  const statusBadge = (s: string) => {
    ...
    return (
      <span
        className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-semibold capitalize ${colors[s] ?? colors.closed}`}
      >
        {s}
      </span>
    );
  ...
  return (
    <div className="relative flex flex-col gap-6 overflow-hidden">
      ...
      {stats && (
        <div className="relative grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            <div
              key={s.label}
              className="group relative overflow-hidden rounded-2xl border border-black/8 dark:border-white/8 bg-white dark:bg-[#111116] p-5 transition-all hover:shadow-xl hover:shadow-indigo-500/5"
            >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-black/8 dark:border-white/8 bg-white dark:bg-[#111116]">
        <div
          className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-indigo-500 to-violet-500 opacity-0 transition-opacity hover:opacity-100"
          ...
          filteredBoards.length === 0 ? (
            ...
            <div className="divide-y divide-black/5 dark:divide-white/5">
              {filteredBoards.map((b) => (
                <div
                  key={b.id}
                  className="group/item relative flex items-center gap-3 px-5 py-3.5 transition-colors hover:bg-black/[0.02] dark:hover:bg-white/[0.02]"
                >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-3 px-5 py-4">
              <div>
                ...
                <input
                  autoFocus
                  className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#1c1c1e] px-3 py-2 text-sm text-[#1d1d1f] dark:text-white placeholder-[#aeaeb2] focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
                  maxLength={100}
              ...
              <div>
                ...
                <textarea
                  className="w-full resize-none rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#1c1c1e] px-3 py-2 text-sm text-[#1d1d1f] dark:text-white placeholder-[#aeaeb2] focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
                  maxLength={2000}
            ...
            <div className="flex justify-end gap-2 border-t border-black/6 dark:border-white/6 px-5 py-3">
              ...
              <button
                className="rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all hover:shadow-xl hover:shadow-indigo-500/30 disabled:opacity-50"
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {["low", "medium", "high", "urgent"].map((p) => (
                    <label
                      key={p}
                      className="flex cursor-pointer items-center gap-1.5 text-sm text-[#1d1d1f] dark:text-white"
                    >
                      <input
                        checked={priority === p}
