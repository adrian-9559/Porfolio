...
export const aiHubService = {
  ...
  createMCP: (input: Partial<AIHubMCP>) =>
    apiFetch<AIHubMCP>(`${API}/mcps`, {
      method: "POST",
      body: JSON.stringify(input),
    }),
  updateMCP: (id: string, input: Partial<AIHubMCP>) =>
    apiFetch<AIHubMCP>(`${API}/mcps/${id}`, {
      method: "PATCH",
      body: JSON.stringify(input),
    }),
  deleteMCP: (id: string) =>
  ...
  createSkill: (input: Partial<AIHubSkill>) =>
    apiFetch<AIHubSkill>(`${API}/skills`, {
      method: "POST",
      body: JSON.stringify(input),
    }),
  updateSkill: (id: string, input: Partial<AIHubSkill>) =>
    apiFetch<AIHubSkill>(`${API}/skills/${id}`, {
      method: "PATCH",
      body: JSON.stringify(input),
    }),
  ...
  createModel: (input: Partial<AIHubModel>) =>
    apiFetch<AIHubModel>(`${API}/models`, {
      method: "POST",
      body: JSON.stringify(input),
    }),
  updateModel: (id: string, input: Partial<AIHubModel>) =>
    apiFetch<AIHubModel>(`${API}/models/${id}`, {
      method: "PATCH",
      body: JSON.stringify(input),
    }),
  ...
  // Seed
  seed: () =>
    apiFetch<{ skillsInserted: number; mcpsInserted: number }>(`${API}/seed`, {
      method: "POST",
    }),
};
