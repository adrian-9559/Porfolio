...
export const allContent: ContentMeta[] = [
  ...
  // ── New tools ────────────────────────────────────────────────────────────────
  {
    ...
    featured: false,
    tags: ["unidades", "conversión", "medidas"],
  },
  {
    id: "tip-calculator",
    slug: "tip-calculator",
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["propinas", "cálculo", "restaurante"],
  },
  {
    id: "countdown-timer",
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["temporizador", "timer", "cuenta atrás"],
  },
  {
    id: "pomodoro-timer",
    slug: "pomodoro-timer",
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["pomodoro", "productividad", "enfoque"],
  },
  {
    id: "bmi-calculator",
    slug: "bmi-calculator",
  ...
  },
  {
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["relojes", "zonas horarias", "mundial"],
  },
  {
    id: "issue-tracker",
    slug: "issue-tracker",
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["incidencias", "kanban", "gestión", "equipos"],
  },
  {
    id: "json-yaml",
    slug: "json-yaml",
  ...
  },
  {
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["regex", "expresiones regulares", "referencia"],
  },
  {
    id: "markdown-html",
    slug: "markdown-html",
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["markdown", "HTML", "convertidor"],
  },
  {
    id: "text-counter",
    slug: "text-counter",
  ...
  },
  {
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["contraste", "WCAG", "accesibilidad"],
  },
  {
    id: "image-compressor",
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["imágenes", "compresión", "optimización"],
  },
  {
    ...
    description:
      "Elimina el fondo de tus imágenes con IA directamente en el navegador. Tus imágenes nunca salen de tu dispositivo. Descarga en PNG con transparencia a la resolución original.",
    categoryId: "documentos",
    category: "Documentos",
    categoryColor: "bg-red-500",
    level: "beginner",
    ...
    featured: true,
    tags: ["imágenes", "fondo", "transparencia", "IA", "privacidad"],
  },
  {
  ...
  },
  {
    ...
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["contraseñas", "seguridad", "fortaleza"],
  },
  {
    id: "wifi-qr",
    slug: "wifi-qr",
  ...
  },
  {
    ...
    description:
      "16 mockups vectoriales (8 web + 8 mobile) con 5 colores editables en tiempo real. Inspiración para interfaces y sistema de diseño.",
    categoryId: "design",
    category: "Diseño",
    categoryColor: "bg-pink-500",
    level: "beginner",
    ...
    prerequisites: [],
    objectives: [
      "Explorar 16 ejemplos de diseño web y mobile",
      "Modificar colores en tiempo real con pickers",
      "Exportar la paleta como variables CSS",
    ],
    publishedAt: "2026-08-25",
    featured: false,
    tags: ["Diseño", "UI", "UX", "Mockup", "SVG", "Web", "Mobile", "Colores"],
  },
  {
    id: "password",
    slug: "password",
  ...
  },
  {
    ...
    description:
      "Implementa observabilidad completa: métricas con Prometheus, dashboards en Grafana, logging con Loki y trazas distribuidas con OpenTelemetry + Jaeger. Configura alerting con Alertmanager.",
    ...
    objectives: [
      "Entender los tres pilares de la observabilidad: métricas, logs y trazas",
      "Configurar Prometheus para recolectar métricas de aplicaciones y infraestructura",
      "Crear dashboards en Grafana con paneles y alertas visuales",
      "Centralizar logs con Loki y Grafana",
      "Instrumentar aplicaciones con OpenTelemetry para trazas distribuidas",
    ],
    publishedAt: "2026-09-01",
    featured: true,
    tags: ["Monitoreo", "Observabilidad", "Prometheus", "Grafana", "DevOps"],
  },
  {
    id: "terraform-iac",
    slug: "terraform-iac",
    ...
    description:
      "Domina Terraform: declarativo vs imperativo, HCL, providers, recursos y data sources, variables y outputs, módulos reutilizables, remote state y despliegue CI/CD de infraestructura.",
    categoryId: "iac",
    ...
    objectives: [
      "Entender IaC y por qué declarativo supera a imperativo",
      "Escribir configuraciones Terraform con HCL: providers, recursos y data sources",
      "Gestionar variables, outputs y secrets de forma segura",
      "Crear módulos reutilizables para infraestructura repeatable",
      "Configurar remote state y workspaces para colaboración en equipo",
    ],
    publishedAt: "2026-09-01",
    featured: true,
    tags: ["Terraform", "IaC", "Infraestructura", "HCL", "DevOps"],
  },
  // ── Languages ───────────────────────────────────────────────────────────
  {
    id: "go",
...
export const allGuides: GuideMeta[] = [
  ...
  },
  {
    ...
    title: "Ruta DevOps",
    description:
      "Automatiza el ciclo de vida completo de tus aplicaciones: Git, Docker, CI/CD con GitHub Actions, Kubernetes, monitoreo y observabilidad con Prometheus/Grafana, e infraestructura como código con Terraform.",
    categoryId: "ci-cd",
    category: "DevOps",
    categoryColor: "bg-violet-600",
    branch: "backend",
