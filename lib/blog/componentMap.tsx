...
> = {
  ...
  "markdown-preview": {
    es: MarkdownPreviewContent,
    en: MarkdownPreviewContent,
  },
  "jwt-decoder": { es: JwtDecoderContent, en: JwtDecoderContent },
  "url-encoder-decoder": {
    es: UrlEncoderDecoderContent,
    en: UrlEncoderDecoderContent,
  },
  ...
  "regex-visualizer": {
    es: RegexVisualizerContent,
    en: RegexVisualizerContent,
  },
  "barcode-generator": {
    es: BarcodeGeneratorContent,
    en: BarcodeGeneratorContent,
  },
  ...
  "regex-cheatsheet": {
    es: RegexCheatsheetContent,
    en: RegexCheatsheetContent,
  },
  ...
  "contrast-checker": {
    es: ContrastCheckerContent,
    en: ContrastCheckerContent,
  },
  "image-compressor": {
    es: ImageCompressorContent,
    en: ImageCompressorContent,
  },
  "favicon-generator": {
    es: FaviconGeneratorContent,
    en: FaviconGeneratorContent,
  },
  "og-image-generator": { es: OgImageContent, en: OgImageContent },
  "password-analyzer": {
    es: PasswordAnalyzerContent,
    en: PasswordAnalyzerContent,
  },
