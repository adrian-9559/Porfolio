...
export const educationData: EducationData[] = [
    ...
    subjects: [
      {
        ...
        description:
          "Ensamblaje, diagnóstico y reparación de hardware informático",
      },
      {
        name: "Sistemas Operativos Monopuesto",
        description: "Instalación y configuración de Windows y Linux",
      },
      {
        name: "Redes Locales",
        description: "Fundamentos de redes, protocolos y topologías",
      },
      {
        name: "Sistemas Operativos en Red",
        description: "Administración de Windows Server y Active Directory",
      },
      {
        name: "Aplicaciones Web",
        description: "Introducción al desarrollo y gestión de aplicaciones web",
      },
      {
        name: "Seguridad Informática",
        description: "Protocolos de seguridad, backups y políticas",
      },
      {
        name: "Servicios de Red e Internet",
        description: "DNS, DHCP, FTP, HTTP y otros servicios",
      },
      {
        name: "Formación en Centros de Trabajo",
        description: "Prácticas en empresa del sector TIC",
      },
    ],
    projects: [
      {
        ...
        description:
          "Diseño e implementación de una red empresarial completa en Cisco Packet Tracer con VLANs, DHCP, DNS y políticas de seguridad.",
        technologies: ["Cisco Packet Tracer", "TCP/IP", "VLANs"],
      },
      {
        name: "Infraestructura Windows Server",
        description:
          "Despliegue de un controlador de dominio con Active Directory, GPOs, usuarios y equipos en un entorno virtualizado.",
        technologies: ["Windows Server 2019", "Active Directory", "VirtualBox"],
      },
      {
        name: "Servidor Linux multiservicio",
        description:
          "Instalación y configuración de un servidor Ubuntu con servicios web (Apache), FTP (vsftpd), SSH y gestión de usuarios.",
    ...
    subjects: [
      {
        ...
        description: "JavaScript avanzado, DOM, eventos y frameworks frontend",
      },
      {
        name: "Desarrollo Web en Entorno Servidor",
        description: "Node.js, Express, APIs REST y autenticación",
      },
      {
        name: "Diseño de Interfaces Web",
        description: "HTML5, CSS3, responsive design y accesibilidad",
      },
      {
        name: "Bases de Datos",
      ...
      },
      {
        ...
        description: "Servidores, cloud, CI/CD y Docker",
      },
      {
        name: "Proyecto de Desarrollo",
        description: "Aplicación completa full-stack con equipo",
      },
      {
        name: "Formación en Centros de Trabajo",
        description: "Prácticas en empresa de desarrollo web",
      },
    ],
    projects: [
      {
        name: "GymGO",
        description:
          "Aplicación web y móvil para gestión de rutinas de entrenamiento con seguimiento de progreso personalizado. Autenticación JWT, panel de administración y estadísticas.",
        technologies: [
          "React",
          "Node.js",
          "PostgreSQL",
      ...
      },
      {
        name: "CodeXplore",
        description:
          "Plataforma educativa para aprender programación con cursos interactivos, sistema de seguimiento de progreso y gestión de usuarios.",
        technologies: [
          "Next.js",
          "TypeScript",
          "Tailwind CSS",
  ...
  },
  {
    ...
    subjects: [
      {
        name: "Libft",
        description: "Reimplementación de la librería estándar de C desde cero",
      },
      {
        name: "ft_printf",
        description: "Implementación del printf con variadic functions",
      },
      {
        name: "get_next_line",
        description: "Lectura de ficheros línea a línea con file descriptors",
      },
      {
        name: "Born2beroot",
        description:
          "Administración de sistemas Linux: usuarios, sudo, firewall, SSH",
      },
      {
        name: "so_long / fdf",
        description: "Gráficos 2D con la librería MLX (mini libX)",
      },
      {
        name: "push_swap",
        description: "Algoritmo de ordenación óptimo con dos pilas",
      },
      {
        name: "pipex",
        description: "Reimplementación de pipes y redirecciones de Shell",
      },
      {
        name: "minishell",
        description: "Shell funcional con builtins, variables y señales en C",
      },
      {
        name: "philosophers",
        description:
          "Concurrencia, hilos, mutexes y el problema de los filósofos",
      },
      {
        name: "cub3D",
        description:
          "Motor gráfico 3D tipo raycasting inspirado en Wolfenstein 3D",
      },
      {
        name: "CPP Modules (00-09)",
        description: "Programación orientada a objetos y patrones en C++",
      },
      {
        name: "ft_irc",
        description: "Servidor IRC completo con sockets, clientes y canales",
      },
    ],
    projects: [
      {
        name: "cub3D",
        description:
          "Motor gráfico 3D tipo raycasting en C con renderización en tiempo real. Implementación completa de perspectiva, colisiones, texturas y sprites inspirada en Wolfenstein 3D.",
      ...
      },
      {
        name: "ft_irc",
        description:
          "Servidor IRC (Internet Relay Chat) en C++ con soporte para múltiples clientes simultáneos, canales, operadores, mensajes directos y todos los comandos del protocolo IRC.",
        technologies: [
          "C++",
          "Sockets POSIX",
          "Multiplexing I/O",
